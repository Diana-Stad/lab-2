...
1. **Ввод данных:**  
  - Создается одномерный массив w размером N,она также обозначает какое количество слов введено в массив.
   - В каждом элементе этого массива хранится строка, представляющая слово на английском/русском алфавитах.
